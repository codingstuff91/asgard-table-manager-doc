...
<section class="container max-w-6xl mx-auto px-6 py-10 md:py-12">
    <div class="flex flex-col-reverse mb-10 lg:flex-row lg:mb-24">
        <div class="mt-8">
            ...
            <p class="text-lg">Test edition 2 pour voir. <br class="hidden sm:block">Generate elegant, static docs quickly and easily.</p>
    ...
    <div class="md:flex -mx-2 -mx-4">
        <div class="mb-8 mx-3 px-2 md:w-1/3">
            ...
            <p>This is a test is a powerful, simple, and beautiful templating language, and now you can use it for your static sites, not just your Laravel-powered apps.</p>
        </div>
        ...
        <div class="mb-8 mx-3 px-2 md:w-1/3">
            ...
            <p>test is the web’s leading format for writing articles, blog posts, documentation, and more. Jigsaw makes it painless to work with Markdown content.</p>
        </div>
